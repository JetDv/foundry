...
|---|---|---|
| starting a new run | `stages/01_{name}/CONTEXT.md` | human reads the output |
| `01`'s output approved | `stages/02_{name}/CONTEXT.md` | human reads the output |
...
`AGENTS.md` is canonical. `CLAUDE.md` is a pointer to it. Never maintain two copies.
